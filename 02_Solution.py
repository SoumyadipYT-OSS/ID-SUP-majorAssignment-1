...
# 2. Create a line chart for student ids and Computer Science marks. Student id on the x-axis and Computer Science mark on the y-axis.

from matplotlib import pyplot as plt

def create_line_chart(students):
    ...
    plt.plot(student_ids, computer_science_marks)
    plt.xlabel("Student ID")
    plt.ylabel("Computer Science Mark")
    plt.title("Student ID vs Computer Science Mark")
    plt.show()

create_line_chart(students)