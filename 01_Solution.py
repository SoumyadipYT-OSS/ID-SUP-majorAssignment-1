...
def group_students_by_science_mark(students, mark):
    return [student["student id"] for student in students if student["Science"] <= mark]

print(group_students_by_science_mark(students, 30))
...
def group_students_by_science_mark(students, mark1, mark2):
    return [student["student id"] for student in students if mark1 < student["Science"] < mark2]

print(group_students_by_science_mark(students, 30, 70))
...
print(group_students_by_science_mark(students, 70))