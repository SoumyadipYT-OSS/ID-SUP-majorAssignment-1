...
# 3. Write a Python program to create a list of 20 vectors by taking student's Math, Computer Science and Science marks.
#     Find the sum of all these 20 vectors. After that, find the average marks for Math, Cmpter Science and Science.


# • Create a list of 20 vectors
def create_vector(students):
    return [[student["Math"], student["Computer Science"], student["Science"]] for student in students]

vectors = create_vector(students)
print("\nList of 20 vectors: ")
print(vectors)
print("\n")


# • Find the sum of all these 20 vectors
def sum_of_vectors(vectors):
    return [sum([vector[i] for vector in vectors]) for i in range(3)]

sum_vector = sum_of_vectors(vectors)
print("Sum of all 20 vectors: ")
print(sum_vector)
print("\n")


# • Find the average marks for Math, Computer Science and Science
def average_marks(vectors, n):
    return [vector/n for vector in vectors]

average_vector = average_marks(sum_vector, len(vectors))
print("Average marks for Math, Computer Science and Science: ")
